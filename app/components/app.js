...
class ApplicationBase extends React.Component {
  ...
  handleToggleTimer () {
    this.setState({
      viewingTimer: !this.state.viewingTimer
    })
  }

  render () {
    const { players, editingPlayer, viewingTimer } = this.state
    ...
    return (
      <View style={styles.container}>
        ...
        />
        <Timer visible={viewingTimer} onDismiss={this.handleToggleTimer} />
        <TitleBar
          onRightButtonPress={this.handleToggleTimer}
        />
